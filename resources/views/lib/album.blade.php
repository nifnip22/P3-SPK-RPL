...
@section('main-content')
    ...
    <div class="flex items-center gap-4 mb-4" data-aos="fade-up" data-aos-delay="500">
        ...
        <button class="btn btn-primary text-gray-100" onclick="my_modal_5.showModal()"><i class="fa-solid fa-plus"></i> Tambah Album</button>
    </div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 2xl:grid-cols-4 md:gap-x-8 xl:gap-x-20 gap-y-10" data-aos="fade-up" data-aos-delay="300">
        @foreach ($album as $a)
        <a href="{{ route('album.show', ['album' => $a->id]) }}" class="flex items-center justify-center">
            <div class="card w-80 md:w-96 bg-base-100 ring-2 ring-gray-300 hover:ring-primary hover:shadow-xl hover:shadow-teal-100 duration-300">
