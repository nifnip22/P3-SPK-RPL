...
@section('main-content')
    ...
    @if ($likedFoto->isNotEmpty())
        <div class="mb-10 grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-20" data-aos="fade-up" data-aos-delay="300">
    ...
    @else
        <div class="message" data-aos="fade-up" data-aos-delay="700">
            <h1 class="text-xl sm:text-2xl md:text-3xl lg:text-4xl font-bold opacity-30 text-center mt-28 mb-28">Untuk
                Sementara, Anda Belum Menyukai Foto Apapun</h1>
        </div>
    @endif
@endsection
